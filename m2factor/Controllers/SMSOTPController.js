...
'use strict';
angular.module('M2Factor').factory('SMSOTPController',function($q,Configuration,HttpClient,APIHelper){
    return{
        /**
         * This endpoint is used to check SMS OTP balance
         * @param {string} apiKey    Required parameter: API Obtained From 2Factor.in
         *
         * @return {promise<CheckSmsBalanceModel>}
         */
        getCheckSMSBalance : function(apiKey){
         ...
         *
         * @return {promise<SendingSmsOtpAutoGeneratedOtpModel>}
         */
        getSendingSMSOTPAutoGeneratedOTP : function(apiKey, phoneNumber){
            //Assign default values
            apiKey = apiKey || "Get one from http://2Factor.in";
         ...
         * @param {string} phoneNumber    Required parameter: 10 Digit Indian Phone Number
         *
         * @return {promise<SendingSmsOtpModel>}
         */
        getSendingSMSOTPCustomOTP : function(apiKey, otp, phoneNumber){
            //Assign default values
            apiKey = apiKey || "Get one from http://2Factor.in";
            otp = otp || "4499";
            phoneNumber = phoneNumber || "9911991199";
         ...
         *
         * @return {promise<VerifyOtpInputModel>}
         */
        getVerifySMSOTPInput : function(apiKey, otpInput, sessionId){
            //Assign default values
            apiKey = apiKey || "Get one from http://2Factor.in";
